...
interface InventoryRepository {
    ...
    suspend fun createInventory(inventory: InventoryDto): Result<Inventory, DataError.Remote>
    suspend fun updateInventory(inventory: InventoryUpdateDto): Result<Inventory, DataError.Remote>
